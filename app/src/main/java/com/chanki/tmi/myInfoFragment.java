...
public class myInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String major = extra.getString("major");
        View v = inflater.inflate(R.layout.fragment_my_info, container, false);
        TextView userName = (TextView) v.findViewById(R.id.userNameShow);
        TextView userMajor = (TextView) v.findViewById(R.id.userMajorShow);
        userName.setText("반갑습니다 " + id + "님");
        userMajor.setText("전공: "+ major);
